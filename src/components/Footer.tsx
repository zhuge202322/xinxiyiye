    ...
    <footer className="bg-gray-900 text-gray-300 pt-20 pb-10">
      <div className="max-w-[1440px] mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            <h4 className="text-white font-bold text-lg mb-6">{t('footer.products')}</h4>
            <ul className="space-y-4 text-gray-400">
              {categories.slice(0, 6).map((cat: any) => (
                <li key={cat.id}>
                  <a href={`${lp}/shop?category=${cat.slug}`} className="hover:text-brand-primary transition flex items-center group">
          ...
          <div>
            <h4 className="text-white font-bold text-lg mb-6">{t('footer.company')}</h4>
            <ul className="space-y-4 text-gray-400">
              <li><a href={`${lp}/about`} className="hover:text-brand-primary transition flex items-center group"><ArrowRight className="w-3 h-3 mr-2 opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all" /> {t('footer.about')}</a></li>
              <li><a href={`${lp}/oem-odm`} className="hover:text-brand-primary transition flex items-center group"><ArrowRight className="w-3 h-3 mr-2 opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all" /> {t('footer.oemOdm')}</a></li>
              <li><a href={`${lp}/news`} className="hover:text-brand-primary transition flex items-center group"><ArrowRight className="w-3 h-3 mr-2 opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all" /> {t('footer.blog')}</a></li>
              <li><a href={`${lp}/contact`} className="hover:text-brand-primary transition flex items-center group"><ArrowRight className="w-3 h-3 mr-2 opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all" /> {t('footer.contact')}</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-white font-bold text-lg mb-6">{t('contact.title')}</h4>
            <ul className="space-y-4 text-gray-400">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm text-gray-500">
            <a href="#" className="hover:text-brand-primary transition">{t('footer.privacy')}</a>
            <a href="#" className="hover:text-brand-primary transition">{t('footer.terms')}</a>
          </div>
        </div>
      </div>
    </footer>
